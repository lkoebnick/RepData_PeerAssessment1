...
In order to get a general idea of daily activity levels, I analyzed two months of data from a personal activity monitoring device. The dataset can be downloaded from the Coursera Reproducible Research web page.
...
It looks like the individual took between 5000 and 15,000 steps each day with an average around 10,000 steps per day. To confirm this, I found the mean and median number of steps taken per day.
...
I made a time series plot of the average number of steps taken in each 5 minute interval. This will show how activity levels change throughout the day.
